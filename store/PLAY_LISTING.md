# Google Play Store Listing (ASO / SEO optimised)

## App name (30 chars max)
`Combo Universal: Display List` (29)
...
BRANDS COVERED
Samsung, Xiaomi, Redmi, Poco, Mi, Vivo, iQOO, Oppo, Realme, OnePlus, iPhone, Motorola, Infinix, Tecno, Itel, Lava, Benco, Huawei, Honor, ZTE and more.

FEATURES
• Smart highlight search across every category at once
• Category → brand → list browsing
• Save lists as bookmarks for quick access
• Recent searches
...
Websites: combouniversal.com · combosupport.in
...
- Contact email + website + phone required
- Privacy policy URL: publish `store/PRIVACY_POLICY.md` at https://combouniversal.com/privacy-policy/
